package it.tcgroup.vilear.dummy.controller.payload.response;
...
public class TeacherResponseV1 {
    ...
    public TeacherResponseV1(String username, String name, String surname, String fiscalCode, Date dateOfBirth, String birthPlace, String phone, String email, String professionalArea, Boolean publicEmployee, Boolean accreditedFt, String accreditedFtCode, Boolean authorized, Boolean professionalOrderRegistration, String register, Boolean vatHolder, String vatNumber, String sector, String note, String curriculumVitae, AddressResponse address) {
