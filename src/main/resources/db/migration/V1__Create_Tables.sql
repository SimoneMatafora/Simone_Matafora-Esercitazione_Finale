...
CREATE TABLE IF NOT EXISTS course (
	...
	course_start_date  timestamp with time zone NULL,
	course_end_date timestamp with time zone NULL,
	...
	afternoon_start_hour TIME NULL,
	...
	sended_project_date timestamp with time zone NULL,
	receipt_FT_confirmation_date timestamp with time zone NULL,
	sended_canceled_project_date timestamp with time zone NULL,
	aut_progetct_FT_realized_date timestamp with time zone NULL,
	sended_learners_FT_date timestamp with time zone NULL,
	...
	number_of_tickets numeric NULL,
	...
	amount_autorized_FT_date timestamp with time zone NULL,
	...
	sended_paper_reporting_date timestamp with time zone NULL,
	sended_eletronic_reporting_date timestamp with time zone NULL,
	expired_reporting_date timestamp with time zone NULL,
	invoice_authorization_date timestamp with time zone NULL,
	delivery_date_in_administration timestamp with time zone NULL,
	commercial_taxable_communication_date timestamp with time zone NULL,
